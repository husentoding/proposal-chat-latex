...
\addto{\captions bahasa}{\renewcommand{\bibname}{Daftar Pustaka}}
\usepackage{fancyhdr}
\pagestyle{fancy}
\lhead{}
\chead{}
...
\title{Klasifikasi Data Percakapan dengan Algoritma Naive Bayes untuk Chatbot Youme}\let\Title\@title   %Judul dalam bahasa Indonesia

\newcommand{\EngTitle}{Dialogue Data Classification using Naive Bayes Algorithm for Chatbot Youme}  %Judul dalam bahasa Inggris

\author{Muhammad Husain}  \let\Author\@author  %Nama mhs
\newcommand{\NIM}{1301153626}
\newcommand{\Prodi}{Teknik Informatika}
\newcommand{\KK}{ICM} %UNTUK TA
\newcommand{\Gelar}{Sains Komputasi} % UNTUK TA
\date{2016}           \let\Date\@date %Masukkan hanya tahun saja
